...
const TRAVEL_GEAR = [
  {
    ...
    price: 'From $295',
    color: '#0f766e',
    img: 'https://images.unsplash.com/photo-1488646953014-85cb44e25828?w=400&h=240&fit=crop&auto=format',
  ...
  },
  {
    ...
    price: 'From $25',
    color: '#7c3aed',
    img: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=400&h=240&fit=crop&auto=format',
  ...
  },
  {
    ...
    price: 'From $149',
    color: '#1d4ed8',
    img: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=400&h=240&fit=crop&auto=format',
  ...
  },
  {
    ...
    price: 'From $15',
    color: '#dc2626',
    img: 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=400&h=240&fit=crop&auto=format',
  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 mt-6 pb-12">
        ...
        {/* Dual platform spinners — visible from search start until both are done */}
        {(loading || bookingDone) && (
          <div className="flex items-center gap-4 my-4">
            {/* Booking.com */}
            <div className="flex items-center gap-2.5">
              <div className={`w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0 ${bookingDone ? 'bg-teal' : 'bg-gray-100'}`}>
                {bookingDone ? (
              ...
              <span className={`text-xs font-semibold ${bookingDone ? 'text-teal' : 'text-gray-400'}`}>Booking.com</span>
            </div>
            ...
            {/* Agoda */}
            <div className="flex items-center gap-2.5">
              <div className={`w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0 ${agodaPrices && !agodaUpdating ? 'bg-orange-400' : 'bg-gray-100'}`}>
                {agodaPrices && !agodaUpdating ? (
                  <svg className="w-3 h-3 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3.5}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                  </svg>
                ) : (loading || agodaUpdating) ? (
              ...
              <span className={`text-xs font-semibold ${agodaPrices && !agodaUpdating ? 'text-orange-500' : (loading || agodaUpdating) ? 'text-gray-400' : 'text-gray-300'}`}>Agoda</span>
            </div>
          </div>
        )}
